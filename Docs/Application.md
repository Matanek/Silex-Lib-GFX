...
is the smallest complete windowed application. It adds frame pacing because an
otherwise empty application has no renderer or presentation step to regulate
its loop.
